...
class EnvironmentSensor:
    def __init__(self, device_id: int, scl_gpio: int, scl_freq_hz: int, sda_gpio: int, sample_rate_hz: int, duration: int, display_data_to_lcd: bool=False, print_data: bool=False, graph_data: bool=False, button_gpio=None):
