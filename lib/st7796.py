...
def Help():
    ...
    print('Text(Messave, x, y, color1, color0)    Send Message to the LCD starting at (x,y) scaling = 1')
    print('Text2(Messave, x, y, color1, color0)   Send Message to the LCD starting at (x,y) scaling = 2')
